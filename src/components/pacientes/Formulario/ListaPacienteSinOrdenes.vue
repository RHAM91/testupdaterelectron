        ...
        <b-row>
            <b-col sm="12" class="mt-2">
                <b-input-group size="sm">
                    ...
                    <b-form-input type="search" v-model="searchn" id="sino"  size="sm" placeholder="Buscar" autocomplete="off"></b-form-input>
                </b-input-group>
            </b-col>
...
export default {
    ...
    computed: {
        ...
        searchn: {
            get (){
                return this.$store.state.filterPacientes.nocliente
            },
            set(val){
                this.$store.commit('set_querypacientenocli', val.toLowerCase())
            }
        },
        rows(){
        ...
        ...mapGetters({
            spacientes : 'filteredPacienteNoCli'
        })
    },
    data() {
        return {
